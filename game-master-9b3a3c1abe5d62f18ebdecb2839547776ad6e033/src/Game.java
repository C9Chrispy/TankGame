...
class Game {
     ...
     */
    private void TurnSwitchDisplay(int Turn) {
    ...
    private void MakeHelpMenu() {
		...
		Text WinCondition = new Text(0, 0.2*XSIZE, "Be the first player to win 2 rounds. The first player to hit the opponent a total of 5 times wins the round.");
     ...
     */
    private void handleMouseScenes(double x, double y){
